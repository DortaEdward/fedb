...
DB_CONTAINER_NAME="op-deck-builder-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=op-deck-builder -d -p 5432:5432 docker.io/postgres
